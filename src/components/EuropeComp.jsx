...
import carotia from'../img/carotia.jpg'
...
const EuropeComp = () => {
  return (
    <div className="EuropeComp">
      ...
      <div className="cards">
        <div>
          <img alt="Malta" src={carotia} className="country" style={{"border":"1px solid black"}} />
        </div>
        <div>
          <h3>CAROTIA</h3>
        </div>
      ...
      <div className="cards">
        <div>
          <img alt="Malta" src={portugal} className="country" style={{"border":"1px solid black"}} />
        </div>
        <div>
          <h3>PORTUGAL</h3>
        </div>
